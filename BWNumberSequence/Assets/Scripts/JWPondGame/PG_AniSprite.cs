...
public class PG_AniSprite : MonoBehaviour
{
...
public void  playSpriteSheetAnimation(int colCount ,int rowCount ,int colNumber,int rowNumber,int totalCells,int fps, bool bLoop){
	...
	// function for animating sprites
public void  playSpriteSheetAnimationForJump(int colCount ,int rowCount ,int colNumber,int rowNumber,int totalCells,int fps, bool bLoop){
	    // Calculate index
    int index  = (int)(Time.time * fps);
	if(bLoop)
		index = index % totalCells;
